...
- `python -m baselines.ppo2.run_mujoco --attention parameter` runs the algorithm for 1M frames on a Mujoco environment, and the "attention" parameter represents the attention type.
